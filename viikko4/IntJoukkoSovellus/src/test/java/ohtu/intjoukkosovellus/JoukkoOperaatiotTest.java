...
public class JoukkoOperaatiotTest {
    ...
    public void testYhdiste() {
        ...
        IntJoukko tulos = Operaatiot.yhdiste(eka, toka);
        int[] vastauksenLuvut = tulos.asArray();
    ...
    public void testLeikkaus() {
        ...
        IntJoukko tulos = Operaatiot.leikkaus(eka, toka);
        int[] vastauksenLuvut = tulos.asArray();
        Arrays.sort(vastauksenLuvut);
    ...
    public void testErotus() {
        ...
        IntJoukko tulos = Operaatiot.erotus(eka, toka);
        int[] vastauksenLuvut = tulos.asArray();
        Arrays.sort(vastauksenLuvut);
